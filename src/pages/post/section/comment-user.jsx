...
function CommentUserSection({comments}) {
  ...
  return (
    <div>
      <button 
        ...
        onClick={() => dispatch(openFormComment(true))}
      >
        <h2 className='group-hover:text-white transition-all text-sm'>Add Comment</h2>
        <IoAddCircleOutline size={20} className="text-green-500 group-hover:text-white transition-all" />
      </button>
